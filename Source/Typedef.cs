...
namespace TinTin {
  ...
  public class typedef<T> {
    ...
    private static bool IsNumeric(object value) {
      return IsInteger(value) || IsFloatingPoint(value);
    }
    ...
    private static decimal GetNumeric(object value) {
      if (value == null)
        throw new NullReferenceException("typedef<T>.GetNumeric");
    ...
    private static long GetInteger(object value) {
      if (value == null)
        throw new NullReferenceException("typedef<T>.GetInteger");
    ...
    private static decimal GetFloatingPoint(object value) {
      if (value == null)
        throw new NullReferenceException("typedef<T>.GetFloatingPoint");
    ...
    public override bool Equals(object obj) {
      return obj != null && ReferenceEquals(MValue.GetType(), obj.GetType()) && MValue.Equals(obj);
    }
