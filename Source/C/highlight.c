...
DO_COMMAND(do_highlight) {
  ...
  if (*arg1 == 0) {
    ...
    if (get_highlight_codes(ses, arg2, temp) == FALSE) {
      ...
      tintin_printf2(ses,
                     "reset, bold, light, faint, dim, dark, underscore, blink, reverse, black, red, green, yellow, blue, magenta, cyan, white, b black, b red, b green, b yellow, b blue, b magenta, b cyan, b white, azure, ebony, jade, lime, orange, silver, tan, violet.");
    } else {
